...
function showSnacks() {
  ...
  if (b.fields.type.includes('creamy') &&(b.fields.color.includes('red')||b.fields.color.includes('brown'))) {
    return true;
  } else {
    return false
  }
  ...
  if (a.fields.type.includes('savory') &&(a.fields.color.includes('red')||a.fields.color.includes('brown'))) {
    return true;
  } else {
    return false
  }
